...
public class DriversCustomList extends ArrayAdapter<Driver> {

    Context context;
    int layoutResourceId;
    ArrayList<Driver> items;

    public DriversCustomList(Context context, ArrayList<Driver> items, int layoutResourceId) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (row == null) {
            ...
            row = inflater.inflate(R.layout.driver_list_row_item, null);
...
//            holder.setStationsBtn((Button) row.findViewById(R.id.stationsBtn));
        ...
        Driver itemListObject = items.get(position);
