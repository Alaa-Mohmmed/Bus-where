...
public class AddSupervisorActivity extends AppCompatActivity implements AddInterface, GetDataInterface {
...
//        HelperMethods.getData(AddSupervisorActivity.this, "Bus", "Please wait", "Loading");
...
//        currentSupervisor.setBusName(busesSpinner.getSelectedItem().toString());
        ...
        HelperMethods.pushInFireBase("Supervisor", currentSupervisor, AddSupervisorActivity.this, "Please wait", "Loading...", currentSupervisor.getEmail().toString().replace(".", "").trim());
    ...
    public void updateUI(DatabaseError databaseError) {
        if (databaseError == null) {
            ...
            Toast.makeText(AddSupervisorActivity.this, "Added successfully", Toast.LENGTH_LONG).show();
            finish();
        } else {
            databaseError.toException().printStackTrace();
            Log.i("Details", "updateUI: " + databaseError.getDetails());
            Log.i("msg", "updateUI: " + databaseError.getMessage());
            Toast.makeText(AddSupervisorActivity.this, "error in saving", Toast.LENGTH_SHORT).show();
        }
    }
